...
export default function ExpensesPage() {
  ...
  return (
    <div dir="rtl" style={{ fontFamily:'sans-serif', background:'#f9fafb', minHeight:'100vh' }}>
      ...
      {/* Top Bar */}
      <div style={{ background:'linear-gradient(135deg,#C0392B 0%,#E74C3C 100%)', padding:'16px 20px', display:'flex', alignItems:'center', gap:'12px', position:'sticky', top:0, zIndex:50, boxShadow:'0 2px 12px rgba(192,57,43,0.3)' }}>
