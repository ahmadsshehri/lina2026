...
export default function CashflowPage() {
  ...
  return (
    <div dir="rtl" style={{ fontFamily:'sans-serif', background:'#f9fafb', minHeight:'100vh' }}>
      ...
      {/* Top Bar */}
      <div style={{ background:'linear-gradient(135deg,#0E6655 0%,#16A085 100%)', padding:'16px 20px', display:'flex', alignItems:'center', gap:'12px', position:'sticky', top:0, zIndex:50, boxShadow:'0 2px 12px rgba(14,102,85,0.3)' }}>
